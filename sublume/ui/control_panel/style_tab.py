...
class StyleTabMixin:
    ...
    def _create_style_tab(self):
        from sublume.ui.overlay.subtitle_overlay import DEFAULT_STYLE

        from sublume.ui.overlay.handle import (
    ...
    def _on_preset_changed(self, index):
        from sublume.ui.overlay.subtitle_overlay import STYLE_PRESETS
