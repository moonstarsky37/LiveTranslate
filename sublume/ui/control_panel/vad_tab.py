...
from sublume.i18n import t, LANGUAGES
...
class VadTabMixin:
    ...
    def _create_vad_tab(self):
        ...
        try:
            from sublume.core.audio_capture import list_output_devices
        ...
        try:
            from sublume.core.audio_capture import list_input_devices
    ...
    def _update_whisper_size_label(self):
        from sublume.model_manager import is_asr_cached, _MODEL_SIZE_BYTES
    ...
    def _on_whisper_size_changed(self):
        ...
        from sublume.model_manager import is_asr_cached
    ...
    def _download_whisper(self):
        from sublume.model_manager import is_asr_cached, get_missing_models
        ...
        if not missing:
            return
        from sublume.ui.dialogs import ModelDownloadDialog
    ...
    def _on_ui_lang_changed(self, index):
        ...
        from sublume.i18n import set_lang
