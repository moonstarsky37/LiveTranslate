...
window creation and tray hookup. Extracted from sublume/main.py (PR 3.4).
"""
...
# sublume.main applies the model-cache env vars and enforces the
# torch-before-PyQt6 import order at module level; import it first.
from sublume.main import SublumeApp
...
from sublume.ui.log_window import LogWindow
from sublume.ui.control_panel import (
    ControlPanel,
    SETTINGS_FILE,
    _load_saved_settings,
    _save_settings,
)
from sublume.ui.dialogs import (
    SetupWizardDialog,
    ModelDownloadDialog,
)
from sublume.ui.tray import build_tray
from sublume.i18n import t, set_lang
...
def setup_logging():
    ...
    log_file = log_dir / f"sublume_{datetime.now():%Y%m%d_%H%M%S}.log"
    ...
    _logger = logging.getLogger("Sublume")
