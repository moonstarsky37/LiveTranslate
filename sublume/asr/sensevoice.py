...
log = logging.getLogger("Sublume.SenseVoice")

SAMPLE_RATE = 16000
DEFAULT_PAD_SECONDS = 0.5
PAD_SECONDS_ENV = "SUBLUME_SENSEVOICE_PAD_SECONDS"
...
class SenseVoiceEngine:
    ...
    def __init__(self, model_name=None, device="cuda", hub="hf", pad_seconds=None):
