...
from sublume.model_manager.registry import (
    ASR_DISPLAY_NAMES,
    ASR_MODEL_IDS,
...
log = logging.getLogger("Sublume.ModelManager")
...
# independently so model_manager keeps zero imports from sublume.core.
