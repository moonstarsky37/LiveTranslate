...
This module owns LiveTranslateApp (pipeline wiring + runtime state); the
startup flow (QApplication, wizard, tray) lives in livetranslate/app.py.
"""
...
from livetranslate.model_manager import apply_cache_env
...
from livetranslate.ui.control_panel import ControlPanel
